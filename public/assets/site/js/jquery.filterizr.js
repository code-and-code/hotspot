    ...
    $.fn.filterizr.prototype = {
        ...
        */
        toggleFilter: function(toggledFilter) {
            ...
            self.trigger('filteringStart');
            //Toggle the toggledFilter in the active contents
        ...
        */
        _makeMultifilterArray: function() {
            ...
            for (var i = 0; i < self._mainArray.length; i++) {
                //If the item belongs to multiple contents
                var item = self._mainArray[i],
                    belongsToCategory = false,
                    isUnique = item.domIndex in addedMap === false;
                //Check if item belongs to contents whose filters are toggled on
        ...
        */
        ...
        /**
        * Handles filtering in/out and reposition items when transition between contents
        ...
        */
        _handleFiltering: function(target) {
            ...
            //Minimize all .filtr-item elements that are not the same between contents
    ...
    */
    var FiltrItemProto = {
        ...
        */
        ...
        /**
        * Determines which contents this items belongs to and updates the _lastCategory prop of Filterizr.
        * @throws {InvalidArgumentException} data-category of .filtr-item elements must be integer or string of integers delimited by ', '
        * @return {Object[]|number} the contents this item belongs to.
        * @private
        */
