...
-- Copiando dados para a tabela hotspot.content: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `content` DISABLE KEYS */;
INSERT INTO `content` (`id`, `name`, `content`, `flag`, `page_id`, `created_at`, `updated_at`) VALUES
	(1, 'Banner', '', 'banner', 1, '2016-06-13 16:44:14', '2016-06-23 19:09:21'),
	...
	(12, 'Beneficios', 'Beneficios', 'beneficios', 2, NULL, NULL),
...
INSERT INTO `information` (`id`, `title`, `content`, `icon`, `content_id`, `created_at`, `updated_at`) VALUES
	...
	(12, 'Escritório Compartilhado', '<p>Espa&ccedil;o compartilhando com outros profissionais.</p><p>Modalidade em que o cliente contrata uma esta&ccedil;&atilde;o de trabalho e utiliza o coworking compartilhando com outros profissionais ambiente de trabalho. Dentro da mesma estrutura, profissionais de diversos ramos de atividade trabalham individualmente. Servi&ccedil;os de telefonia, recep&ccedil;&atilde;o, caf&eacute;, &aacute;gua, limpeza e manuten&ccedil;&atilde;o est&atilde;o inclu&iacute;dos na mensalidade. Outros podem ser solicitados sob demanda como motoboy e correios.</p><p>Vantagens:</p><ul><li>Servi&ccedil;os de telefonia</li><li>Internet</li><li>Recep&ccedil;&atilde;o</li><li>Caf&eacute;</li><li>&Aacute;gua.</li><li>Limpeza e manuten&ccedil;&atilde;o</li><li>Material para escrit&oacute;rio</li><li>Ambiente climatizado</li></ul>', 'leaf', 7, '2016-06-17 11:31:34', '2016-06-21 17:36:30'),
	...
	(24, 'Lista Vantagens 1', '<p>Escritorio em uma &aacute;rea nobre com baixo custo.</p>', '', 9, '2016-06-17 12:10:56', '2016-06-23 19:25:04'),
	(25, 'Lista Vantagens 2', 'Mobília e estrutura completa.', '', 9, '2016-06-17 12:10:57', NULL),
	(27, 'Lista Vantagens 3', 'Recepção, cozinha, sala de reuniões.', '', 9, NULL, NULL),
	(29, 'Lista Vantagens 4', 'Várias empresas ao seu lado.', '', 9, NULL, NULL),
	(31, 'Lista Vantagens 5', 'Linhas telefonicas', '', 9, NULL, NULL),
	(33, 'Lista Vantagens 6', 'Conforto e privacidade.', '', 9, NULL, NULL),
	...
	(39, 'Lista Beneficios 1', 'Menor custo operacional.', 'list', 12, NULL, NULL),
